...
task_data = json.loads(raw.strip().lower())
...
"""
Fetch Tock data from API.
"""
r = requests.get('http://tock-app.18f.gov/api/users.json')
...
"""
Fetch Tock data from application (if running within same env).
"""
...
print('\nFound matches between Float "im" values and Tock "username" '
...
print('\nData updated to include Django fixture requirements.')
