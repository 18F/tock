    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('working_hours', models.PositiveSmallIntegerField(default=40, validators=[django.core.validators.MaxValueValidator(40)])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, auto_created=True, verbose_name='ID', serialize=False)),
                ('time_percentage', models.DecimalField(decimal_places=0, validators=[django.core.validators.MaxValueValidator(100)], max_digits=3)),
